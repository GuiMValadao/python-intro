...
* A forma sugerida para executar o jogo é lançar o executável 'MusicGame.exe', que foi criado usando pyinstall. Alternativamente, pode-se executar main.py usando Python3. No entanto, devido a incompatibilidade de PyGame com a versão 3.14 de Python, pode-se haver dificuldades de baixar pygame para essa versão do Python (a versão do Python desse projeto é 3.13.12, e a versão do Pygame é 2.6.1).
